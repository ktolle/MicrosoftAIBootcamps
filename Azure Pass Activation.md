...
If everything is OK, you will see the next screen

![Redeemed - Microsoft Azur https:// Microsoft Azure Create a resource All services \* FAVORITES Dashboard All resources Resource groups App Services f Function Apps SQL SQL databases Azure Cosmos DB Virtual machines Load balancers Storage accounts Virtual networks Azure Active Directory C' Monitor Advisor Security Center Cost Management + Billing Help + support Dashboard - Microsoft Dashboard All resources ALL SUBSCRIPTIONS O O 1.4 ihor.leontiev\@hotm.ai... DEFAULT DIRECTORY 4- New dashboard upload Download Edit C; Share p Seorch cesaurres, services, ar.å dory Full screen Clone fiil Delete No resources to display Try changing your filters if you don't see what you're Inking for. Learn more Create resources Azure getting started made easy! Launch an app of your choice on Azure in a few quick steps Create Devops Project Quickstarts + tutorials Welcome to Microsoft Azure Let's show you around before you get started. Start tour Functions Z Maybe later Service Health Marketplace Process events with a serverless code architecture SQL Database Z Managed relational SQL Database as a Service ](media/97ddc5a2bb52ca3c381261a122bfecd8.png)

If having a problem, please contact:

**Official Facebook & Instagram pages–** see everything that is happening at
each Artificial Intelligence bootcamp, starting with **Alice Envisions the
